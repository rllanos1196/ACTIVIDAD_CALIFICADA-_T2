...
namespace ACTIVIDAD_CALIFICADA__T2
{
    public partial class Enunciado2 : Form
    {
        ...
        private void actulizarDueño()
        {
            ...
            {
                ListViewItem t_item = new ListViewItem(t_dueño.Nombre);
                t_item.SubItems.Add(t_dueño.Direccion);
                t_item.SubItems.Add(t_dueño.Telefono);
        ...
        private void actualizarMascota()
        {
            ...
            {
                cbDueño.Items.Add(dueño.Nombre);
            }
            ...
            foreach (Mascota mascota in Form1.listMascota)
            {
                ...
                item.SubItems.Add(mascota.Edad.ToString());
                item.SubItems.Add(mascota.Raza);
                item.SubItems.Add(mascota.Dueño.Nombre);
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                cont++;
                if (mascota.Nombre.Equals(t_nombre))
                {
